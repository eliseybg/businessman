...
public class DBHelperPoints extends SQLiteOpenHelper {
    ...
    public DBHelperPoints(@Nullable Context context) {
    ...
    public void addDataToFC(String col2, String col3, String col4, String col5){
        ...
        db.insert(DBHelperPoints.TABLE_CONTACTS_FC, null, contentValues);
    }
